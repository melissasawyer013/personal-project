...
//     dbHandler.collection(collectionDataSearch).insertOne(userSearchObject, (error, result) => {
//         if (error) {
//             console.log(`There was an error in the search: ${error}`);
//         } else {
//             console.log(`Yes! The search was successful: ${result}`);
//         }
//     })
...
//             })
//             res.render('needs-and-offerings', {
